...
<nav class="flex items-center justify-between flex-wrap bg-purple-600 p-6">
  ...
  <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
    <div class="text-base lg:flex-grow">
      <a href="{{ route('home') }}" class="block ml-8 mt-4 lg:inline-block lg:mt-0 text-white font-semibold hover:text-white mr-4">
        Home
      </a>
      <a href="{{ route('topics') }}" class="block ml-8 mt-4 lg:inline-block lg:mt-0 text-gray-300 font-medium hover:text-white mr-4">
        Topics
      </a>
      <a href="{{ route('about') }}" class="block ml-8 mt-4 lg:inline-block lg:mt-0 text-gray-300 font-medium hover:text-white">
        About
      </a>
      <a href="{{ route('contact') }}" class="block ml-8 mt-4 lg:inline-block lg:mt-0 text-gray-300 font-medium hover:text-white">
        Contact
      </a>
    </div>
